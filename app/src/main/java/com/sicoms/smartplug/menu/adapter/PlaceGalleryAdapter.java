 ...
 */
public class PlaceGalleryAdapter extends RecyclerView.Adapter<PlaceGalleryAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<String> mImageList;
    private OnItemClickListener mItemClickListener;

    public PlaceGalleryAdapter(Context context) {
        mContext = context;
    ...
    @Override
    public PlaceGalleryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_place_gallery, null);
        // create ViewHolder
