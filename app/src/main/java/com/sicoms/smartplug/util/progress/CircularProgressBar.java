...
public class CircularProgressBar extends ProgressBar {
	...
	public void init(AttributeSet attrs, int style){
		...
		String t = "0%";//a.getString(R.styleable.CircularProgressBar_title);
		if(t!=null)
			mTitle = t;

		t = "0%";//a.getString(R.styleable.CircularProgressBar_subtitle);
		if(t!=null)
			mSubTitle = t;
	...
	public void animateProgressTo(final int start, final int end, final ProgressAnimationListener listener){
		...
		progressBarAnimator.setDuration(1200);
    ...
    public synchronized void setSubTitleSize(int size){
        mSubtitlePaint.setTextSize(size);
        invalidate();
    }

    public synchronized void setProgressColorPaint(int color){
