 ...
 */
public class PlugGalleryAdapter extends RecyclerView.Adapter<PlugGalleryAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<String> mImageList;
    private OnItemClickListener mItemClickListener;

    public PlugGalleryAdapter(Context context) {
        mContext = context;
    ...
    @Override
    public PlugGalleryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_plug_gallery, null);
        // create ViewHolder
