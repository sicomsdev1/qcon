...
//            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(drawerHeaderType == DRAWERHEADER_ACCOUNTS) {
            ...
            try {
                username.setTextColor(attributes.getColor(R.styleable.MaterialAccount_titleColor1,0xFFF));
                usermail.setTextColor(attributes.getColor(R.styleable.MaterialAccount_subtitleColor1,0xFFF));
            }
            finally {
                attributes.recycle();
            }
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            kitkatTraslucentStatusbar = windowTraslucentAttribute.getBoolean(0, true);
            if(kitkatTraslucentStatusbar) {
                ...
                statusBar.setImageDrawable(new ColorDrawable(darkenColor(primaryDarkColor)));
...
//        return Color.HSVToColor(hsv);
    ...
    public void setDrawerHeaderBitmap(Bitmap bitmap){
        setDrawerHeaderImage(new BitmapDrawable(getResources(), bitmap));
    }
    ...
    public void setDrawerBackgroundImage(int image) {
        drawer.setBackgroundResource(image);
    }
...
//        section.setPosition(accountSectionList.size());
    ...
    public void addSubheader(CharSequence title) {
        ...
        subheader.setTitleColor(0x000000);
    ...
    public void addListView(ListView listView){
        sections.addView(listView);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,1);
        elementsList.add(new Element(Element.TYPE_LISTVIEW, listView));
    }
